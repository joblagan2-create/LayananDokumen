  ...
  return (
    <html lang="id" className="scroll-smooth">
      <body className={`${inter.className} bg-slate-50 text-slate-900 antialiased flex flex-col min-h-screen`}>
        ...
        {/* IKLAN ATAS GLOBAL (728x90) - FIXED: Menggunakan tanda kutip satu (') agar URL terbaca benar */}
        ...
        {/* IKLAN BAWAH GLOBAL (NATIVE) - FIXED: Menggunakan tanda kutip satu (') */}
        <div className="no-print w-full bg-white border-t border-slate-200 py-6 mt-10">
          <div className="max-w-4xl mx-auto px-4 flex flex-col items-center">
            ...
            <div className="w-full flex justify-center overflow-hidden">
               <iframe
                 srcDoc={`<html><body style='margin:0;'><div id='container-680bbbb6a0645f106a122dd96bf54b25'></div><script async='async' data-cfasync='false' src='https://pl28427514.effectivegatecpm.com/680bbbb6a0645f106a122dd96bf54b25/invoke.js'></script></body></html>`}
